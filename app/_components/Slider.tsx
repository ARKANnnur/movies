...
function Slider({}: Props) {
  return (
    <div className="max-w-[100%] h-96 relative ">
      <Image
      ...
      <div className="absolute bottom-0 w-full h-10  justify-center items-center flex gap-5">
        <div className="w-5 h-1 sm:w-10 md:w-20 bg-light-50 opacity-50 hover:opacity-100 rounded-full cursor-pointer"></div>
        <div className="w-5 h-1 sm:w-10 md:w-20 bg-light-50 opacity-50 hover:opacity-100 rounded-full cursor-pointer"></div>
        <div className="w-5 h-1 sm:w-10 md:w-20 bg-light-50 opacity-50 hover:opacity-100 rounded-full cursor-pointer"></div>
      </div>
    </div>
